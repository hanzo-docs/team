...
Open **Contacts** from the app rail. The navigator splits contacts into **Employee**, **Guest**, **Person**, and **Company**; the **Employee** tab lists everyone in your workspace with their role and contact info:

![Employee/person directory with names, roles and contact info](/img/contacts/people-desktop.png)

*The Contacts directory on the Employee tab, showing names, roles, and last-modified time. (Bot and agent members appear here too — see [Agents & bots](/docs/account/agents-bots).)*

> **On mobile:** the directory scrolls in a single column; some columns are trimmed to fit.

![Employee/person directory with names, roles and contact info (mobile)](/img/contacts/people-mobile.png)

*The Contacts directory on a phone.*
