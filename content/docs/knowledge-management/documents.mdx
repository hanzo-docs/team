...
Open **Documents** from the app rail to see the navigator. Your teamspaces are listed under **Spaces** (the section is labeled "Spaces" in the app), and each one expands to the documents inside it. Use **Create document** at the top, or its dropdown to **Create teamspace**:

![Documents app with the Teamspaces (Spaces) navigator](/img/documents/teamspaces-desktop.png)

*The Documents navigator: teamspaces under **Spaces**, each expanding to its documents.*

> **On mobile:** tap through the navigator to a teamspace, then to a document; the editor opens full-screen.

![Documents app with the Teamspaces (Spaces) navigator (mobile)](/img/documents/teamspaces-mobile.png)

*The Documents navigator on a phone.*
