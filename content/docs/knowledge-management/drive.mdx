...
Open **Drive** from the app rail to see every drive you can access listed under **Drive** in the navigator:

![Drive app listing drives](/img/drive/list-desktop.png)

*The Drive app with your drives listed in the navigator.*

> **On mobile:** the drives list scrolls in a single column; tap a drive to open it.

![Drive app listing drives (mobile)](/img/drive/list-mobile.png)

*Your drives on a phone.*
...
Open a drive to see what's inside — each file lists its name, size, and who created it. Drives keep everything separated, so a team can spin up as many as it needs:

![A drive containing uploaded files (name, size, created by)](/img/drive/file-desktop.png)

*Open a drive to browse its contents; the workspace above holds several drives in the navigator.*

> **On mobile:** open a drive, then tap a file to preview, download, or share it.

![A drive containing uploaded files (name, size, created by) (mobile)](/img/drive/file-mobile.png)

*Browsing drives on a phone.*
