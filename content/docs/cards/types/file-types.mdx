...
* **Card attachments** - Attach files to any Card, regardless of its Type, by adding them directly to the Card’s interface (see [Creating Cards](/docs/cards/creating-cards) for an example). This is a great way to quickly attach a file that doesn't need its own dedicated Card.
