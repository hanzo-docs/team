...
Your projects are listed under **Your Projects** in the Tracker navigator. Each one expands to **Issues**, **Components**, **Milestones**, and **Templates**:

![Tracker project navigator listing projects with Issues, Components, Milestones, Templates](/img/tracker/projects-desktop.png)

*The Tracker navigator: each project expands to Issues, Components, Milestones, and Templates.*

> **On mobile:** open the navigator from the app rail, then tap a project to expand it.

![Tracker project navigator listing projects with Issues, Components, Milestones, Templates (mobile)](/img/tracker/projects-mobile.png)

*The project navigator on a phone.*
