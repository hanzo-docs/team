...
description: Learn how to use the human resources module in Hanzo Team.
---

The human resources module in Hanzo Team allows you to manage scheduling and basic time tracking across your departments. This module is still in development, so some features are not yet complete. We welcome any feedback you have as we continue to improve our offerings in this area. For now, continue reading to learn how to get the most out of the human resources module in its current implementation!
...
You can view the HR schedule for the entire organization or for a specific department. Switch between **Month** and **Year** in the top right, and page through time with the arrows.

![HR module Schedule view (month/year, departments, time off)](/img/hr/schedule-desktop.png)

*The HR Schedule, set to Month. The module is labeled **Human resources (beta)**, and the grid shows "There are no employees in the selected department" until you add departments and members.*

> **Note:** Human resources is a **beta** module. A fresh workspace shows the empty state above — the schedule fills in once you create departments and assign members to them. Treat time-off totals here as a shared record for visibility, not a formal approval system.

> **On mobile:** the schedule is wide, so it's best viewed on a desktop; on a phone the grid scrolls horizontally.

![HR module Schedule view (month/year, departments, time off) (mobile)](/img/hr/schedule-mobile.png)

*The HR Schedule on a phone.*
...
> **Note:** Hanzo Team does not currently offer pre-defined workflows for manual approval of time off requests. This feature allows team members to record their time off and remote work for visibility, rather than being integrated into a formal tracking system.
...
> **Note:** This early implementation of time tracking in Hanzo Team is still in development, so we suggest using this feature as a general guide rather than a precise tracking tool until the functionality is complete.
